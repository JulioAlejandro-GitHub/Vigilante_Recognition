...
class RecognitionFaceModel(Base):
    ...
    blur_score = Column(Numeric(10, 6), nullable=True)
    face_detector_score = Column(Numeric(10, 6), nullable=True)
    pose_score = Column(Numeric(10, 6), nullable=True)
    occlusion_score = Column(Numeric(10, 6), nullable=True)
